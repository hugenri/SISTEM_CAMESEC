...
// Recuperar el idOrdenCompra del cuerpo de la solicitud
$idOrdenCompra = isset($_POST['idOrdenCompra']) ? $_POST['idOrdenCompra'] : null;

// Si el idOrdenCompra no está presente o no es válido, devuelve un error
if (!$idOrdenCompra) {
...
if(empty($idOrdenCompra)){
    $response = array('success' => false, 'message' => 'Falta el id de cotización');
...
<div class="row justify-content-center">
    <div class="col-lg-11 col-md-11">
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-0" id="servicio">Servicio: ' . $ordenCompra[0]["servicio_ofrecido"] . '</p>
...
// Aquí colocarás el código para generar el PDF basado en los detalles de la orden de compra
// Asegúrate de incluir todas las bibliotecas y definiciones necesarias para generar el PDF

// Finalmente, envía el contenido del PDF como respuesta
echo $pdf_content; // $pdf_content es la representación en cadena del contenido del PDF
