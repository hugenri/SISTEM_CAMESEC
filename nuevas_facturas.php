...
<h4>Nuevos Facturas en curso</h4>
</div>
</div>

    <div id="contenedor-servicios" class="row row-cols-1 row-cols-md-2 row-cols-lg-2 g-4">
...
<div class="row justify-content-end">
    <div class="col-md-6 mb-2">
        ...
        <p class="text-right mb-0">Costo Instalacion: <span id="instalacion"></span></p>
        <p class="text-right mb-0">Subtotal: <span id="subtotal"></span></p>
        <p class="text-right mb-0">IVA: <span id="iva"></span></p>
        <p class="text-right mb-0">Descuento: <span id="descuento"></span></p>
        <p class="text-right mb-0">Total: <span id="total"></span></p>
    </div>
</div>
...
<script  src="assets/JS/get_nuevas_facturas.js"></script>
