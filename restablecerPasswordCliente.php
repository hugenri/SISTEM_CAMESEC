...
<?php
$titulo_pagina = "Restablecer password cliente";
...
<div class="row justify-content-center align-items-center mt-2 mb-3">
   ...
   <h3 class="mb-3">Restablecer contraseña del Cliente</h3>
        </div>
...
<script src="assets/JS/restablecer_password_cliente.js"></script>
