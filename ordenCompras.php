...
<div class="col-lg-6 col-md-1 mb-2">
        <div class="card  compras-custom-card text-center mb-2 align-items-center justify-content-center"
            onclick="window.location.href='compra_productos.php';" style="cursor: pointer;">
            <img src="assets/images/compras1.png" class="mt-2 mb-2" alt="Imagen2">
            <div class="card-body">
                <h5 class="card-title">Nuevas ordenes de compras de las Ventas</h5>
    ...
    <div class="col-lg-6 col-md-1 mb-2">
        <div class="card  compras-custom-card  text-center mb-2 align-items-center justify-content-center"
            ...
            <div class="card-body">
                <h5 class="card-title">Nuevas ordenes de compras de los servicios</h5>
