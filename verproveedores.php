...
<h3 id="titulo" class="mb-3">Lista de Proveedores</h3>
...
<div class="card">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 mt-1 mb-1">
                   ...
                   <a id="pdfLink" class="btn btn-primary btn-md custom-button" href="#" onclick="generarInformePDF('reporteProveedoresPDF.php')">Generar informe PDF</a>
                    </div>
                </div>
       </div>
        <div class="card-body">
...
<div class="col-lg-10 col-md-10">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="text-center mb-0">Editar Proveedor</h4>
  ...
  <h6>Datos Personales</h6>
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <div class="invalid-feedback">Por favor, ingresa información de contacto válida (solo letras, mínimo 8, máximo 30 caracteres)</div>
        </div>
      </div>
      <div class="row mb-3">
      <div class="col-md-12">
...
<script  src="assets/JS/ver_proveedores.js"></script>
...
<script>
  var formulario = document.getElementById('formUpdateProveedor');
</script>
